              ...
              <li>
                <a className="text-gray-600 hover:text-gray-800">Fourth Link</a>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-2">
                        ...
                        <div className="flex justify-start items-start justify-center md:justify-start">
                            <a className="w-52" href='https://play.google.com/store/apps/details?id=app.vyap.app.twa&hl=en_IN&gl=US&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'>
                                <img alt='Get it on Google Play' src={playStore} />
                            </a>

                            <a className="w-52 ml-2" href="https://apps.apple.com/us/app/vyap/id1608763967?itsct=apps_box_badge&amp;itscg=30200" 
                            >
                                <img 
                                src={appStore}
